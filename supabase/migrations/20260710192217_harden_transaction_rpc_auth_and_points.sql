...
revoke all on function private.lock_expected_client_points(jsonb) from public;
...
revoke all on function public.apply_product_stock_delta_unchecked_20260710(text, numeric) from public, anon, authenticated;
revoke all on function public.register_sale_transaction_unchecked_20260710(jsonb, jsonb, jsonb, jsonb) from public, anon, authenticated;
revoke all on function public.edit_sale_transaction_unchecked_20260710(text, jsonb, jsonb, jsonb, jsonb) from public, anon, authenticated;
revoke all on function public.void_sale_transaction_unchecked_20260710(text, timestamptz, jsonb, jsonb) from public, anon, authenticated;
...
revoke all on function public.apply_product_stock_delta(text, numeric) from public, anon;
revoke all on function public.register_sale_transaction(jsonb, jsonb, jsonb, jsonb) from public, anon;
revoke all on function public.edit_sale_transaction(text, jsonb, jsonb, jsonb, jsonb) from public, anon;
revoke all on function public.void_sale_transaction(text, timestamptz, jsonb, jsonb) from public, anon;
