        ...
        <div className="grid min-h-0 flex-1 gap-0 overflow-hidden lg:grid-cols-[300px_minmax(360px,1fr)_300px]">
          <div className="order-2 min-h-0 space-y-2 overflow-y-auto px-3.5 pb-3.5 pt-1 md:px-4 md:pb-4 md:pt-1.5">
            ...
            <div className="grid gap-2">
              <div className="sale-success-member-card min-w-0 rounded-xl border border-sky-100 bg-gradient-to-br from-sky-50 to-white px-3 py-2">
                ...
                <div className="mt-1 grid gap-1 sm:grid-cols-4">
                  <div className="sale-success-metric-cell rounded-lg border border-sky-100 bg-white/80 px-2.5 py-1">
                  ...
                  <div className="sale-success-metric-cell rounded-lg border border-rose-100 bg-white/80 px-2.5 py-1">
                  ...
                  <div className="sale-success-metric-cell rounded-lg border border-emerald-100 bg-white/80 px-2.5 py-1">
                  ...
                  <div className="sale-success-metric-cell rounded-lg border border-blue-100 bg-white/80 px-2.5 py-1">
              ...
              <div className="sale-success-purchase-card rounded-xl border border-slate-200 bg-white px-3 py-2.5">
                ...
                <div className="mt-2 grid gap-1.5 text-[13px] text-slate-700 sm:grid-cols-2">
                  <div className="sale-success-purchase-cell flex items-center justify-between gap-3 rounded-lg border border-slate-200 bg-slate-50 px-3 py-1.5">
...
export const TicketModal = ({ transaction, onClose, onPrint }) => {
  ...
  return (
    <div className="ticket-view-modal fixed inset-0 z-[60] flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm">
      <div className="ticket-view-panel flex max-h-[92vh] w-full max-w-md flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
        <div className="ticket-view-header flex items-center justify-between border-b bg-slate-100 px-5 py-4 shrink-0">
        ...
        <div className="ticket-view-body flex justify-center overflow-y-auto bg-slate-200 px-7 py-8">
          <div className="ticket-view-ticket-frame rounded-2xl border border-slate-200 bg-white p-3 shadow-sm">
            <div className="ticket-view-ticket-paper rounded-xl bg-white px-3 py-4">
              <TicketPrintLayout transaction={transaction} />
            </div>
          </div>
        </div>

        <div className="ticket-view-footer border-t bg-white p-5 shrink-0">
          <button
            onClick={onPrint}
