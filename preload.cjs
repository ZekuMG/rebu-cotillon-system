...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  saveExportPdf: (payload) => ipcRenderer.invoke('save-export-pdf', payload),
  ...
  supplierCredentialsSave: (credentials) => ipcRenderer.invoke('supplier-credentials-save', credentials),
